...
#pragma region 관계 연산자
	...
	// 관계 연산자는 조건이 맞을 때 1이라는 값으로 반환하며, 조건이 틀릴 때 0이라는 값으로 반환합니다. 
#pragma endregion
...
#pragma region else문
	...
	// if문에 연결된 모든 조건문의 조건이 같다면 가장 위에 있는 조건문만 실행됩니다. 
#pragma endregion
...
// 특정한 지점에서 분기를 탈출하는 제어문입니다. 
	...
	// switch문에는 조건식으로 실수형 변수와 실수형 상수를 사용할 수 없습니다. 
#pragma endregion
