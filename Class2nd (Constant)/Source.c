...
#pragma region 십진수를 이진수로 변환하는 과정
	...
	// 10 진수를 1이 될 때까지 계속 2로 나누어 준 다음 나눈 위치의 나머지 값을 아래에서 위로 순서대로 정렬합니다. 
...
#pragma region  이진수를 십진수로 변환하는 과정
	...
	//각각의 비트에 1이 있다면 1과2 의 제곱의 위치를 계산한
	// 다음 각각의 비트를 모두 더하여 10진수로 나타냅니다. 
#pragma endregion



	//메모리는 비트 단위로 데이터를 저장할 수 잇으며, 1개의 비트에는 0 또는 1의 값만 저장할 수 있습니다. 
#pragma endregion
...
#pragma region  비트 연산자
  // 비트 단위로 논리 연산을 수행하기 위해 사용하는 연산자입니다. 
	...
	//
	//// AND 연산자는 두 개의 피연사자가 모두 1이면 1을 반환하는 연산자입니다. 
	//
	//char n = 12; // 0000 1100
	//char m = 3; //0000 0011
	//
	...
	//
	//// OR 연산자는 두 개의 피연산자 중에 하나라도 1이 있다면 1을 반환하는 연산자입니다. 
	//
	//char w = 11; // 1011
	//char v = 5; // 0101
	//
	...
	//
	//// XOR 연산자는 두 개의 피연산자가 서로 같으면 0을 반환하고, 서로 다르면 1을 반환하는 연산자입니다. 
	//
	//char k = 9; //0000 1001
	//
...
#pragma region 시프트 연산자
	// 각각의 비트를 오른쪽 또는 왼쪽으로 한 칸씩 이동시키는 연산자입니다. 
