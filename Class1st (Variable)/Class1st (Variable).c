...
#pragma region 자료형 
	//데이터를 저장하기 위해 데이터의 형태를 정해주는 것입니다. 
		...
		// char -> 1 byte (문자형) -128~127 사이의 값을 저장할 수 있습니다. 

		// ;(세미 콜론): 한 문장의 끝을 알려주는 기호입니다. 

		//자료형은 각각의 자료형마다 크기가 정해져 있으며, 자료형의 크기는 바이트 단위로 이루어져 있고,
		//자료형의 경우 자료형에 따라 저장할 수 있는 값의 종류와 범위가 정해져 있습니다. 
...
#pragma region 대입 연산자
	// 변수에 값을 저장할 수 있는 연산자입니다. 
		...
		// int -> 4 byte (정수형) 
		// 대입 연산자의 기준으로 왼쪽에 있는 변수는 식별자를 가지고 있기 때문에 다른 값을 저장할 수 있습니다. 
#pragma endregion
